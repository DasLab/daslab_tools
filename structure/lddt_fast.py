...
Usage:
    lddt_fast.py ref.pdb model1.pdb model2.pdb ...
    lddt_fast.py -nc ref.pdb model1.pdb ...          # skip stereocheck
    lddt_fast.py --ilddt ref.pdb model1.pdb ...      # also compute ilddt
    lddt_fast.py --chain-mapper ref.pdb model1.pdb   # sequence-based chain mapping
